        ...
        public void AnadirUnPatrocinador(int patrocinador, int cantidad, int duracion, int equipo, int manager)
        {
            try
            {
                using (SQLiteConnection conn = new SQLiteConnection(Conexion.Cadena))
                {
                    ...
                    // Consulta SQL para obtener las finanzas del equipo
                    string query = @"INSERT INTO contratos_patrocinador (id_patrocinador, id_equipo, id_manager, cantidad, duracion_contrato) 
                                     VALUES (@IdPatrocinador, @IdEquipo, @IdManager, @Cantidad, @Duracion)";
        ...
        public Patrocinador? PatrocinadoresContratados(int manager, int equipo)
        {
            ...
            try
            {
                using (SQLiteConnection conn = new SQLiteConnection(Conexion.Cadena))
                {
                    ...
                    // Consulta SQL para obtener las finanzas del equipo
                    string query = @"SELECT p.id_patrocinador, p.nombre, p.reputacion, c.cantidad, c.duracion_contrato
